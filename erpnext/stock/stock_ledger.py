...
def make_entry(args, allow_negative_stock=False, via_landed_cost_voucher=False):
	...
	sle.insert()
	sle.submit()
	frappe.db.sql("""update `tabStock Ledger Entry` set posting_time=date_add(posting_time, INTERVAL right(name,4)/1000000 SECOND_MICROSECOND)
					where name=%s""", (sle.name))
	return sle.name
